            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-2">
                        ...
                        <span class="text-sm text-[#800020] font-semibold tracking-tight hidden md:inline">Réservations</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('disponibilites.index')" :active="request()->routeIs('disponibilites.*')">
                        Disponibilités
                    </x-nav-link>
